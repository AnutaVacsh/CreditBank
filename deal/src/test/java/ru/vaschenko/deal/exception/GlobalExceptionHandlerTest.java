...
import ru.vaschenko.deal.controllers.handlers.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
  ...
  public void testHandleScoringCalculationException() {
    // Given
    ScoringCalculationException exception = new ScoringCalculationException("Scoring error");
